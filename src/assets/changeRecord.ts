...
const changeRecord: ChangeRecordType = {
  ...
  "entries": [
    {
      "title": "הוספת הזזת עיפרון לקואורדינטות XY",
      "date": "11-08-2024",
      "content": "הוספת הוראה להזיז את העיפרון למקום X,Y"
    },
    {
      "title": "הוספת עובי קו",
      "date": "08-08-2024",
      "content": "הוספת הוראה לקבוע את עובי הקו שיצוייר לכל מספר בין 0 ו-50"
    },
    {
      "title": "הוספת פנייה בזוית לציור",
      "date": "07-08-2024",
      "content": "הוספת הוראה לפנות בזוית לבחירת המשתמש"
    },
    {
